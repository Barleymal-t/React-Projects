...
const Links = () => {
  return (
    <section id="links">
        ...
        document.getElementById("mainapp").classList.toggle("hide")}}>about</button>
        <button onClick={()=> {document.getElementById("article").classList.toggle("hide")
        document.getElementById("mainapp").classList.toggle("hide")}}>article</button>
        <button onClick={()=> {document.getElementById("project").classList.toggle("hide")
        document.getElementById("mainapp").classList.toggle("hide")}}>project</button>
        <button onClick={()=> {document.getElementById("contact").classList.toggle("hide")
        document.getElementById("mainapp").classList.toggle("hide")}}>contact</button>
    </section>
  );
};
